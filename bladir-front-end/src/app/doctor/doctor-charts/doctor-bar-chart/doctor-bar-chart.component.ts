...
@Component({
  selector: 'app-doctor-bar-chart',
  templateUrl: './doctor-bar-chart.component.html',
  styleUrls: ['./doctor-bar-chart.component.css']
})
export class DoctorBarChartComponent implements OnInit {

  echartsIntance: any;
  barData;
  graphLoaded = false;
  comments = 'Here is my comments';
